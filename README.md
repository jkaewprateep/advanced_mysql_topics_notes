...
🐑💬 ➰ The ```statistics server manages of statistics data in memory in the same way as the data tables does```, this is for information debugging and communication with the same expectation. </br>
